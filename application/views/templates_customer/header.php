...
<head>
    ...
    <title>Lucque Rentals - Rentals Car</title>
    ...
    <!--=== Main Style CSS ===-->
    <link href="<?php echo base_url('') ?>/assets/assets_shop/style.css" rel="stylesheet">
    <!--=== Responsive CSS ===-->
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 text-left">
                        <i class="fa fa-map-marker"></i> Padalarang, Kab. Bandung Barat.
                    </div>
                    <!--== Single HeaderTop End ==-->

                    <!--== Single HeaderTop Start ==-->
                    <div class="col-lg-3 text-center">
                        <i class="fa fa-mobile"></i> +62 896-0527-9689
                    </div>
                    <!--== Single HeaderTop End ==-->
                    ...
                    <div class="col-lg-3 text-right">
                        <div class="header-social-icons">
                            <a href="<?php echo('https://www.behance.net/luckysopyantoro') ?>"><i class="fa fa-behance"></i></a>
                            <a href="<?php echo('https://www.facebook.com/luckysopyantoro') ?>"><i class="fa fa-facebook"></i></a>
                            <a href="<?php echo('https://www.instagram.com/luckysopyantoro/?hl=id') ?>"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div>
                    <!--== Social Icons End ==-->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li class=""><a href="<?php echo base_url('customer/dashboard') ?>">Home</a>
                                </li>
                                <li><a href="<?php echo base_url('customer/data_mobil')?>">Cars</a>
                                </li>
